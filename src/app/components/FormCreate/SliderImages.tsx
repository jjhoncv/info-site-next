...
export const SliderImages: React.FC<SliderImagesProps> = ({
  ...
  return (
    <div className={`relative w-full h-full  ${className}`}>
      ...
      <div className="absolute z-10 w-full flex justify-center h-full items-center">
        <button
          type="button"
          onClick={() => onClickEdit()}
          className="flex items-center gap-3 bg-sky-600 px-4 py-2 border rounded border-transparent text-white"
        >
          <Edit size={20} />
          Editar
        </button>
